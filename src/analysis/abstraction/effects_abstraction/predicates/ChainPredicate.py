...
class ChainPredicate(Predicate):
    ...
    def add_predicate(self, preds) -> None:
    ...
    def replace_formulas_multiple_but(self, old_to_new, f, gu, now_or_next) -> list:
    ...
    def is_pre_cond(self, gu: Formula, symbol_table) -> None:
        nope = False
        pre = None
        for p in self.chain:
