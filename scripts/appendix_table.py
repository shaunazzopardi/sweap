...
prefix = re.compile(r"out-sweap(-noacc)?-[0-9]{4}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{2}-")
...
logs_sweap = [Path(x).resolve() for x in glob.glob("logs/out-sweap-2*.log")]
...
# process("/home/luca/git/sweap/scripts/logs/out-sweap-2024-04-23-15-15-41-arbiter-paper-5.prog.log")
# process("/home/luca/git/sweap/scripts/logs/out-sweap-noacc-2024-04-23-15-17-18-robot-grid-reach-2d-5.prog.log")
